                    ...
                    <tbody> 
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            while ($r = mysqli_fetch_assoc($result)) {
                                $foto = isset($r['foto']) ? $r['foto'] : 'noface.png';
                                echo '<tr>
                                        <td>' . $no . '</td>
                                        <td>' . $r['nis'] . '</td>
                                        <td>' . $r['nama'] . '</td>
                                        ...
                                        <td>' . $r['kelas'] . '</td>
                                        <td><img src="siswa/foto/' . $foto . '" alt="WebPro" height=65></td>
                                        <td>
                                            <a href="?m=siswa&s=edit&id=' . $r['id'] . '" class="btn btn-warning btn-sm">Edit</a>
                                            <a href="?m=siswa&s=delete&id=' . $r['id'] . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Yakin kelas akan dihapus, Hapus 1 kelas akan menghapus semua data siswa di kelas tersebut\')">Hapus</a>
                                        </td>
                                    </tr>';
                                $no++;
                            }
